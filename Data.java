...
/**
 * This class holds the backend data for the MoodBible.
 */

public class Data {

    /* categories: happy sad angry stressed burntout ashamed jealous insecure */

    /*
     * Format: REFERENCE | VERSE
     */
    public static final String[] HAPPY_VERSES = {
       "Romans 5:2 | through [Jesus] we have gained access by faith into this grace in which we now stand. And we boast in the hope of the glory of God.",
       "1 Peter 4:13 | But rejoice inasmuch as you participate in the sufferings of Christ, so that you may be overjoyed when his glory is revealed", 
       "Deuteronomy 33:29-30 | Blessed are you, Israel! Who is like you, a people saved by the LORD? He is your shield and helper and your glorious sword. Your enemies will cower before you, and you will tread on their heights",
       ...
       "John 16:33 | I have told you these things, so that in me you may have peace. In this world you willhave trouble. But take heart! I have overcome the world.",
    ...
    public static final String[] SAD_VERSES = {
      ...
      "Psalm 46:1-3 | God is our refuge and strength, an ever-present help in trouble. Thereore we will not fear, though the earth give way and the mountains fall into the heart of the sea, though its waters roar and foam and the mountains quake with their surging.",
      "Psalm 16:8 | I keep my eyes always on the LORD. With him at my right hand, I will not be shaken."
    };

    public static final String[] ANGRY_VERSES = {
      ...
      "1 Thessalonians 5:15 | Make sure that nobody pays back wrong for wrong, but always trive to do what is good for each other and for everyone else.",
    ...
    public static final String[] STRESSED_VERSES = {
      ...
      "Matthew 6:34 | Threfore do not worry about tomorrow, for tomorrow will worry about itself. Each day has enough trouble of its own.",
      "Philippians 4:6-7 | Do not be anxious about anything, but in every situation, by prayer and petition, with thanksgiving, present your requests to God. And the peace of God, which transcends all understanding, will guard your hearts and your minds in Christ Jesus."
    };

    public static final String[] BURNTOUT_VERSES = {
      "Isaiah 40:31 | but those who hope in the LORD will renew their strength. They will soar on wings like eagles; they will run and not grow weary, they will walk and not be faint.",
    ...
    public static final String[] ASHAMED_VERSES = {
      "2 Corinthians 12:11 | That is why, for Christ's sake, I delight in weaknesses, in insults, in hardships, in persecutions, in difficulties. For when I am weak, then I am strong.",
      ...
      "Romans 5:4-5 | perseverance, character; and character, hope. And hope does not put us to shame, because God love has been poured out into our hearts through the Holy Spirit, who has been given to us.",
    ...
    public static final String[] JEALOUS_VERSES = {
    ...
    public static final String[] INSECURE_VERSES = {
      "Isaiah 12:2 | Surely God is my salvation; I will trust and not be afraid. The LORD, the LORD himself, is my strength and my defense; he has become my salvation.",
      "Philippians 4:13 | I can do all this through him who gives me strength.",
      "Ephesians 6:13 | Therefore put on the full armor of God, so that when the day of evil comes, you may be able to stand your ground, and after you have done evrything, to stand.",
     ...
     */
    public final String[] HAPPY_SONGS = {
      "Rejoice | Dustin Kensrue | https://www.youtube.com/watch?v=_7Qy1iXZU2g",
      "Blessed Be Your Name | Matt Redman | https://www.youtube.com/watch?v=tTpTQ4kBLxA",
      "10,000 Reasons | Matt Redman | https://www.youtube.com/watch?v=XtwIT8JjddM",
      "How Great is Our God | Chris Tomlin | https://www.youtube.com/watch?v=vg5qDljEw7Q",
      "What A Beautiful Name | Hillsong Worship | https://www.youtube.com/watch?v=nQWFzMvCfLE",
      "Good Good Father | Housefires | https://www.youtube.com/watch?v=djrY_eFDOwE",
      "Wholly Yours | David Crowder Band | https://www.youtube.com/watch?v=vdSKNBNzB4w",
      "King of My Heart | Kutless | https://www.youtube.com/watch?v=-jkMnq2Hfzo",
      "This is Living (Acoustic) | Hillsong Worship Young & Free | https://www.youtube.com/watch?v=BFR-tV2whAU",
      "God Great Dance Floor | Chris Tomlin | https://www.youtube.com/watch?v=R-WOneEXr00"
    };

    public final String[] SAD_SONGS = {

    };

    public final String[] ANGRY_SONGS = {

    };

    public final String[] STRESSED_SONGS = {

    };

    public final String[] BURNTOUT_SONGS = {

    };

    public final String[] ASHAMED_SONGS = {

    };

    public final String[] JEALOUS_SONGS = {

    };

    public final String[] INSECURE_SONGS = {
    ...
    public final String[] HAPPY_TESTIMONIES = {

    };

    public final String[] SAD_TESTIMONIES = {

    };

    public final String[] ANGRY_TESTIMONIES = {

    };

    public final String[] STRESSED_TESTIMONIES = {

    };

    public final String[] BURNTOUT_TESTIMONIES = {

    };

    public final String[] ASHAMED_TESTIMONIES = {

    };

    public final String[] JEALOUS_TESTIMONIES = {

    };

    public final String[] INSECURE_TESTIMONIES = {
